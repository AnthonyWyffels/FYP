...
//this class is everything to do with the study key. 
public class StudieClass {
		...
		Main.txtEnter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					String query = "SELECT * FROM studieinput WHERE '"+ str + "' LIKE CONCAT('%',userinput, '%');";  //FROM table don't put from <name of db> not a good idea!!!
					...
					if(rs.next()) 
					{
						...
						String query2 = "SELECT * FROM studieoutput WHERE categorienb="+ categorie + ";";     
					...
					{
						Main.botSay("I can't help you with that request !");
					}
